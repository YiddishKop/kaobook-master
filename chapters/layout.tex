...
\begin{kaobox}[title=扯淡]
	The \Option{twoside} c你 tm 知道什么吃扯淡么ave been done since the first 
	version of \Class{kaobook}, but some work still needs to be done. As 
	always, any help will be greatly appreciated.
	\end{kaobox}

\begin{kaobox}[title=爱你]

	在“用托盘天平测量物质质量”实验中，应先将天平放在水平桌面上，然后将 \_\_\_
	调节到标尺的“0”刻度处,发现指针左右摆动幅度如图甲所示,这时要将\_\_问题
	就 \underline{\hspace{3em}}出来
...
these entries.} so if you don't \sidenote{关键信息，需要通过相详细的套路
才能面相用户，泳衣帮助用户最大化他们的利用，互利互惠，公式供应} want the entries, just comment the 
corresponding lines.
...
default \acrshort{tocLabel} style.\sidenote{玖辛奈就你不一样跟别人，你凭啥(And please, send me 
...
defined at the moment in this class.\marginnote{千万注意，这里的章节我没有做完，你们看着用.}
...
sidenote\sidenote{日照香炉生紫烟，别挂瀑布挂前川，待到心事搜骚空。
